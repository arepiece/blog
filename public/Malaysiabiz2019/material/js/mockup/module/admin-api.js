...
renderList = function(){
    var columns= [
        ...
        { 
            ...
            render: function(data,type,row,meta){
                return (
                    `<a href="api-form.php?action=edit&id=${meta.row}"><button type="submit" class="btn btn-info btn-sm btn-circle"><i class="ti-pencil-alt"></i></button></a>`+
    ...
    ExtGUI.renderDataTable('#myTable',columns,API.getAllAPI())
}
