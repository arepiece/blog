            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body">
                                <center class="m-t-30"> <img src="images/{{$lesens->avatar}}" class="img-circle" width="150" />
                                    <h4 class="card-title m-t-10">{{$lesens->name}}</h4>
                                    <h6 class="card-subtitle">{{$lesens->role}}</h6>
                            ...
                            <div class="card-body"> <small class="text-muted">Email address </small>
                                <h6>{{$lesens->email}}</h6> <small class="text-muted p-t-30 db">Phone</small>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>Full Name</strong>
                                                <br>
                                                <p class="text-muted">{{$lesens->name}}</p>
                                            </div>
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>Mobile</strong>
                                                <br>
                                                <p class="text-muted">{{$lesens->phone}}</p>
                                            </div>
                                            <div class="col-md-3 col-xs-6 b-r"> <strong>Email</strong>
                                                <br>
                                                <p class="text-muted">{{$lesens->email}}</p>
                                            </div>
...
<!--                                        <form class="form-horizontal form-material">-->
                                             <form method="post" action="{{url('/editemployeeprocess', $lesens->id)}}" enctype="multipart/form-data" class="form-horizontal form-material">
                                                                {{ csrf_field() }}
                                            <div class="form-group">
                                                <label class="col-md-12">Full Name</label>
                                                <div class="col-md-12">
                                                    <input name='name2' type="text" placeholder="" class="form-control form-control-line" value="{{$lesens->name}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="example-email" class="col-md-12">Email</label>
                                                <div class="col-md-12">
                                                    <input name="email" type="email" placeholder="johnathan@admin.com" class="form-control form-control-line" name="example-email" id="example-email" value="{{$lesens->email}}">
                                                </div>
                                            </div>
                                            <div class="form-group">
