                                    ...
                                    <div class="form-body">
                                       <div class="row">
                                            <div class="col-md-6 col-6">
                                                <h3 class="m-b-0">Add New State</h3>                                             
                                            </div>
                                            <div class="col-md-6 col-6">
                                                <div class="text-right">                            
                                                     <a href="admin-state.php"><button type="button" class="btn btn-info waves-effect-light btn-info btn-sm"><i class="ti-check"></i> Save</button></a>
                                                     <a href="admin-state.php"><button type="button" class="btn btn-info waves-effect-light btn-danger btn-sm"><i class="ti-close"></i> Cancel</button></a>
                                                </div>
                                            </div>
                                        </div><hr>
                                         ...
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">State Code <span class="text-danger">*</span></label>
                                                     <input type="text" id="statecode" class="form-control" maxlength="2" placeholder="Enter state code">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="name" id="statename" class="form-control" placeholder="Enter state name">
                                                </div>
                                            </div>
