                                    ...
                                    <div class="form-body">
                                       <div class="row">
                                            <div class="col-md-6 col-6">
                                                <h3 class="m-b-0">Edit Service Field</h3>                                             
                                            </div>
                                            <div class="col-md-6 col-6">
                                                <div class="text-right">                            
                                                     <a href="admin-service-field.php"><button type="button" class="btn btn-info waves-effect-light btn-info btn-sm"><i class="ti-check"></i> Save</button></a>
                                                     <a href="admin-service-field.php"><button type="button" class="btn btn-info waves-effect-light btn-danger btn-sm"><i class="ti-close"></i> Cancel</button></a>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="servicefield" class="form-control" value="Consultancy">
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group-prepend">
                                                        <select class="form-control custom-select select2" data-placeholder="Select Agency" tabindex="1">
                                                            ...
                                                            <option value="Agency 1" selected="">Lembaga Arkitek Malaysia (LAM) </option>
