...
<head>
    ...
    <title name=form-title>API Parameter</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar card-no-border">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6 col-6">
                                                <h3 name="form-title" class="m-b-0">Add New Parameter API</h3>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="text-right">
                                                    <a href="admin-api.php"><button type="button" name="btnSave" class="btn  waves-effect-light btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="Click to submit and back to the main page"><i
                                                                class="ti-check"></i>Submit</button></a>
                                                    <a href="admin-api.php"><button type="button" class="btn waves-effect-light btn-danger btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="Click to cancel and back to the main page"><i
                                        ...
                                        <div class="row m-b-20">
                                            <div class="col-md-6">
                                                <div>
                                                    <label class="control-label">System <span class="text-danger">*</span></label>
                                                    <input type="text" id="name" class="form-control" name="agency">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div>
                                        ...
                                        <div class="row m-b-20">
                                            ...
                                            <div class="col-md-6">
                                                <div>
                                                    <label class="control-label">URL Path <span class="text-danger">*</span></label>
                                                    <input type="text" id="name" class="form-control" name="url_path">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
    ...
    <script>
        $(this).parentSideNavbar('admin-api.php')
    </script>
</body>
<meta name="viewport" content="width=device-width, initial-scale=1">
<style>
