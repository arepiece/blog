                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-2"><a href="admin-division-form.php"> <button class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="right" title="" data-original-title="Click to add new"><i
                                    ...
                                    <table id="myTable-business" class="display nowrap table table-hover table-striped table-bordered"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>A</td>
                                                <td>01</td>
                                                <td>Pengeluaran tanaman dan ternakan, pemburuan dan aktiviti perkhidmatan berkaitan</td>
                                                <td>Plant cultivation and livestock production, hunting and related services</td>
                                                <td>
                                                    <p class="text-success">Yes </p>
                                                </td>
                                                <td>
                                                    <div style="min-width:50px">
                                                        <a href="admin-division-form.php"><button type="submit" class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to edit"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>B</td>
                                                <td>02</td>
                                                <td>Perikanan dan akuakultur</td>
