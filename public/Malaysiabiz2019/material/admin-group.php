                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-sm-2"><a href="admin-group-form.php" <button class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="right" title="" data-original-title="Click to add new"><i
                                    ...
                                    <table id="myTable-business" class="display nowrap table table-hover table-striped table-bordered"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>01</td>
                                                <td>011</td>
                                                <td>Penanaman Tanaman Tidak Kekal</td>
                                                <td>Cultivation of Non-perennial Crops</td>
                                                <td>
                                                    <p class="text-success">Yes </p>
                                                </td>
                                                <td>
                                                    <div style="min-width:50px">
                                                        <a href="admin-group-form.php"><button type="submit" class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to edit"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>01</td>
                                                <td>012</td>
                                                <td>Penanaman Tanaman Kekal</td>
                                                <td>Permanent Plant Cultivation</td>
                                                <td>
                                                    <p class="text-success">Yes </p>
                                                </td>
                                                <td>
