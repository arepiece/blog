                                    ...
                                    <form action="#">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-6">
                                                <h3 class="m-b-0">Edit Group & Role </h3>                                             
                                            </div>
                                            <div class="col-md-6 col-6">
                                                <div class="text-right">                            
                                                     <a href="group-roles.php"><button type="button" class="btn btn-info waves-effect-light btn-info btn-sm"> <i class="ti-check"></i> Save</button></a>
                                                        <a href="group-roles.php" class="btn btn-info waves-effect-light btn-danger btn-sm"><i class="ti-close"></i>Cancel</a>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        <div class="row">
                                                ...
                                                <div>
                                                    <label class="control-label">Group Name <span class="text-danger">*</span></label>
                                                     <input type="text" id="name" class="form-control" placeholder="Super Administrator">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                        ...
                                        <div class="form-actions" align="right">
                                            <a href="../material/group-roles.php"><button type="button" class="btn btn-info waves-effect-light btn-info btn-sm"> <i class="ti-check"></i> Save</button></a>
                                            <a href="../material/group-roles.php" class="btn btn-info waves-effect-light btn-danger btn-sm"><i class="ti-close"></i>Cancel</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
