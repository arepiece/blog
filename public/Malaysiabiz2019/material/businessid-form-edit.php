                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6 col-6">
                                                <h3 class="m-b-0">Add New Business ID </h3>
                                            </div>
                                            <div class="col-md-6 col-6">
                                                <div class="text-right">
                                                    <a href="list-menu.php"><button type="button" class="btn btn-info waves-effect-light btn-info btn-sm"><i
                                                                class="ti-check"></i> Save</button></a>
                                                    <a href="list-menu.php"><button type="button" class="btn btn-info waves-effect-light btn-danger btn-sm"><i
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" placeholder="" data-mask="999999999999" class="form-control">
                                                   </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
