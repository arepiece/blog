                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="admin_feedback.php"<button class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="right" title="" data-original-title="Click to add new" ><i class="ti-plus"></i></button></a>
                                    ...
                                    <div class="table-responsive">
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Part</th>
                                                    <th>Active?</th>                                                   
                                                    <th style="width: 125px !important;">Action</th>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>1</td>
                                                    <td><h6>Sila nyatakan bidang / aktiviti perniagaan:
                                                    <br><small class="font-italic">Please state your business activity(ies):</small></h6></td>
                                                    <td> Short Answer </td>
                                                    <td> 1 </td>
                                                    <td><span class="text-success"> Yes </span> </td>
                                                    <td class="text-center">
                                                        <a href="admin_feedback.php"><button type="submit" class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to edit"><i class="ti-pencil-alt"></i></button></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>2</td>
                                                    <td><h6>Adakah anda mendapati mudah untuk membuat carian maklumat di Portal ini?
                                                    <br><small class="font-italic">Do you find it easy to search for information on this Portal?</small></h6></td>
                                                    <td> Linear Scale</td>
                                                    <td> 2 </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>3</td>
                                                    <td><h6>Penglibatan anda dalam perniagaan (sila tanda dalam kotak yang berkenaan): 

                                                    <br><small class="font-italic">Your involvement in doing business (please tick in the related box):</small></h6></td>
