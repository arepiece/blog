                                ...
                                <div class="row">
                                   ...
                                   <div class="table-responsive">
                                    <table id="myTable" class="table table-bordered table-striped">
                                                <thead>
                                                <tr>
                                                    <th>IC/ Passport / Company No.</th>
                                                    <th>Name / Company Name</th>
													<th>CPD Point</th>
                                                    <th>Total Of Share</th> 
                                                </tr>
                                                </thead>
                                                <tbody>
                                                    <tr>
                                                        <td class="font-bold">730612-10-6999</td>
                                                        <td>Abdul Rasheed Bin Abduh</td>
														<td>8</td>
                                                        <td>70%</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-bold">690110-08-6111</td>
                                                        <td>Salmah Binti Yahya</td>
														<td>10</td>
                                                        <td>10%</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-bold">720717-07-7777</td>
                                                        <td>Musa Bin Muis</td>
														<td>15</td>
                                                        <td>10%</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-bold">691111-10-1224</td>
                                                        <td>Rohana Binti Jalil</td>
														<td>7</td>
                                                        <td>5%</td>
                                                    </tr>
                                                    <tr>
                                                        <td class="font-bold">800908-08-7990</td>
                                                        <td>Rahman Bin Rahim</td>
														<td>11</td>
                                                        <td>5%</td>
                                                    </tr>
                                                </tbody>
