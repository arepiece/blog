                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6 col-6">
                                                <h3 class="m-b-0"> Edit Menu </h3>                                             
                                            </div>
                                            <div class="col-md-6 col-6">
                                                <div class="text-right">                            
                                                     <a href="list-menu.php"><button type="button" class="btn btn-info waves-effect-light btn-info btn-sm"><i class="ti-check"></i> Save</button></a>
                                                     <a href="list-menu.php"><button type="button" class="btn btn-info waves-effect-light btn-danger btn-sm"><i class="ti-close"></i> Cancel</button></a>
                                                </div>
                                            </div>
                                        </div>                                        
                                        <hr>
                                            ...
                                            <div class="col-md-6">
                                                <div>
                                                    <label class="control-label">Menu <span class="text-danger">*</span></label>
                                                     <input type="text" id="name" class="form-control" value="MyTracker">
                                                    </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="path" class="form-control" value="/mytracker">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
