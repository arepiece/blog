                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="admin-section-form.php"> <button class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="right" title="" data-original-title="Click to add new"><i
                                    ...
                                    <table id="myTable-business" class="display nowrap table table-hover table-striped table-bordered"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>1</td>
                                                <td>A</td>
                                                <td>Pertanian, Perhutanan dan Perikanan</td>
                                                ...
                                                <td>
                                                    <div style="min-width:50px">
                                                        <a href="admin-section-form.php"><button type="submit" class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to edit"><i
                                            ...
                                            <tr>
                                                ...
                                                <td>1</td>
                                                <td>B</td>
                                                <td>Perlombongan dan Pengkuarian</td>
