                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-3"><a href="admin-class-form.php" ><button class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="right" title="" data-original-title="Click to add new"><i
                                 ...
                                 <!--   <div class="col-md-3">
                                        <div class="form-group">
                                            <select class="custom-select col-12" id="inlineFormCustomSelect">
                                                <option selected="">Divison Code</option>
                                                <option value="1">A</option>
                                                <option value="2">B</option>
                                                <option value="3">C</option>
                                                <option value="4">D</option>
                                 ...
                                 <!--   <div class="col-md-3">
                                        <div class="form-group">
                                            <select class="custom-select col-12" id="inlineFormCustomSelect">
                                                <option selected="">Class Code</option>
                                                <option value="1">A</option>
                                                <option value="2">B</option>
                                                <option value="3">C</option>
                                                <option value="4">D</option>
                                    ...
                                    <table id="myTable-business" class="display nowrap table table-hover table-striped table-bordered"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>011</td>
                                                <td>0111</td>
                                                <td>Penanaman Bijirin (kecuali padi), tanaman kekacang dan bijian berminyak</td>
                                                <td>The ultivation of cereals (except rice), leguminous crops and oil seeds</td>
                                                <td>
                                            ...
                                            <tr>
                                             ...
                                             <tr>
                                                ...
                                                <td>011</td>
                                                <td>0113</td>
                                                <td>Penanaman Sayur-sayuran Dan Tembikai, Ubi</td>
                                                <td>The cultivation of vegetables and melons, potatoes</td>
                                                <td>
                                                    <p class="text-success">Yes </p>
                                                </td>
                                                <td>
