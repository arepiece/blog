                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a href="menu-form.php"<button class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="right" title="" data-original-title="Click to add new"><i class="ti-plus"></i></button></a>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div style="min-width:50px">
                                                            <a href="menu-form-edit.php"><button type="submit" class="btn btn-info btn-sm btn-circle"><i class="ti-pencil-alt"></i></button></a>
                                                            <button type="submit" class="btn btn-danger btn-sm btn-circle" alt="alert" id="sa-warning" onclick="deleteData('data13');"> <i class="ti-trash"></i></button>
                                                        </div>
                                                    </td>
                                                </tr>
                                                <tr>
