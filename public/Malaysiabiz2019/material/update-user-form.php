...
<html lang="en">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-4">    
                                        <div class="text-right">
                                            <a href="user-page.php"><button type="submit" class="btn btn-info waves-effect-light btn-info btn-sm"><i class="ti-check"></i> Save</button></a>

                                            <a href="user-page.php"><button type="submit" class="btn btn-danger waves-effect-light btn-sm"><i class="ti-close"></i> Cancel</button></a>
                                        </div>
                                    </div>
                                </div><hr>
                                 ...
                                 <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="m-b-10">
                                                     <p class="text-success font-bold"> Already Sent  <br><button type="button" class="btn btn-info waves-effect-light btn-info btn-sm" alt="alert" id="sa-warning" onclick="sentemail('data14');"><i class="icon-paper-plane"></i> Resend</button></p>                                                   
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 col-4">    
                                            <div class="text-right">
                                                <a href="user-page.php"><button type="button" class="btn btn-info waves-effect-light btn-info btn-sm"><i class="ti-check"></i> Save</button></a>

                                                <a href="user-page.php"><button type="button" class="btn btn-danger waves-effect-light btn-sm"><i class="ti-close"></i> Cancel</button></a>
                                            </div>
                                        </div>
                                    </div>
    ...
    function sentemail(id) {
            swal({
                title: "Resend to ahmad@email.com",
                text: "",
                type: "success",
                timer: 3000,
