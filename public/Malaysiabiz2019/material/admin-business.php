...
<body class="fix-header fix-sidebar card-no-border">
 ...
 -->
                               <a href="admin-business-form.php" ><button class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="right" title="" data-original-title="Click to add new"><i
                                    ...
                                    <table id="myTable-business" class="display nowrap table table-hover table-striped table-bordered"
                                        ...
                                        <tbody>
											...
											<tr>
                                                    ...
                                                    <td>
                                                            <a><button type="submit" data-toggle="modal" data-target="#editModal" class="btn btn-info btn-sm btn-circle" ><i class="ti-eye" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to view"></i></button></a>
                                                            <a href="admin-business-form.php"><button type="submit" class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to edit"> <i class="ti-pencil-alt"></i></button></a>
