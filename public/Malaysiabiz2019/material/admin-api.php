...
<head>
    ...
    <title>Pentadbiran Parameter API</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor m-b-0 m-t-0">API</h3>
                        <ol class="breadcrumb">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <a href="api-form.php" ><button class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="right" title="" data-original-title="Click to add new"><i class="ti-plus"></i></button></a>
                                    ...
                                    <table id="myTable-business" class="display nowrap table table-hover table-striped table-bordered"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>BLESS2.0</td>
                                                <td>MG-UR-01</td>
                                                <td>Urusan mendapatkan draf permohonan lesen dari BLESS2.0</td>
                                                <td>getLicenseDraftByNric</td>
                                                <td>
                                                    <p class="text-success">Yes
                                                </td>
                                                <td>
                                                    <a href="api-form.php"><button type="submit" class="btn btn-info btn-sm btn-circle" data-toggle="tooltip" data-placement="top" title="" data-original-title="Click to edit"><i
                                                                class="ti-pencil-alt"></i></button></a> &nbsp
                                            ...
                                            <tr>
                                                ...
                                                <td>BLESS2.0</td>
                                                <td>MG-UR-02</td>
                                                <td>Urusan menghapuskan draf permohonan lesen dari BLESS2.0</td>
                                                <td>licenseSoftDeleteByNric</td>
                                                <td>
