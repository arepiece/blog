                            ...
                            <div class="card-body">
                                <form action="#">
                                    <div class="form-body">
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label class="control-label">Agency ID</label>
                                                     <input type="text" id="agency-id" class="form-control">
                                                    </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">System Abbreviation</label>
                                     ...
                                     <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">System URL</label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Fax Num</label>
                                                     <input type="text" id="agency-tel" class="form-control">
                                                    </div>
                                            </div>
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="form-actions">
                                        <button type="button" class="btn btn-info" onclick="location.href='../material/config-agency.php?added=1'" > <i class="ti ti-check"></i> Save</button>
                                        <button type="button" class="btn btn-inverse" onclick="location.href='../material/config-agency.php'">Cancel</button>
                                    </div>
                                </form>
                            </div>
                        </div>
