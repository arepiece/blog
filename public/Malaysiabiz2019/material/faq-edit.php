                    ...
                    <div class="row page-titles">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                        ...
                                        <form action="#">
                                            <div class="form-body">
                                               <div class="row">
												...
												<a href="faq-list.php"><button type="button" class="btn btn-info waves-effect-light btn-rounded btn-info btn-sm"><i class="ti-check"></i> Save</button></a>
												<a href="faq-list.php"><button type="button" class="btn btn-googleplus waves-effect-light btn-rounded btn-googleplus btn-sm"><i class="ti-close"></i> Cancel</button></a>
												</div>
												</div>
												</div>
                                                <hr>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label class="control-label"><h5>Publish</h5></label>
                                                            <div class="m-b-10">
                                                ...
                                                <div class="row m-t-10">
                                                    <div class="col-md-12">
                                                        <label class="control-label"><h5> Question <span class="text-danger">*</span></h5></label>
                                                        <!-- Nav tabs -->
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">EN</span></a> </li>
                                                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">BM</span></a> </li>
                                                        </ul>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <label class="control-label"><h5>Answer <span class="text-danger">*</span></h5></label>
                                                        <!-- Nav tabs -->
                                                        <ul class="nav nav-tabs" role="tablist">
                                                            <li class="nav-item"> <a class="nav-link active" data-toggle="tab" href="#home2" role="tab"><span class="hidden-sm-up"><i class="ti-home"></i></span> <span class="hidden-xs-down">EN</span></a> </li>
                                                            <li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#profile2" role="tab"><span class="hidden-sm-up"><i class="ti-user"></i></span> <span class="hidden-xs-down">BM</span></a> </li>
								...
								<div class="col-md-4 col-4">	
								<div class="text-right">							
                                 <a href="faq-list.php"><button type="submit" class="btn btn-info waves-effect-light btn-rounded btn-info btn-sm"><i class="ti-check"></i> Save</button></a>
								 
								 <a href="faq-list.php"><button type="submit" class="btn btn-googleplus waves-effect-light btn-rounded btn-googleplus btn-sm"><i class="ti-close"></i> Cancel</button></a>
								</div>
								</div>
                                 </div>
                                        </form>
