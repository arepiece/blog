...
<head>
    ...
    <title>Add New Business Licensing</title>
    <!-- Bootstrap Core CSS -->
                                    ...
                                    <div class="form-body">
                                       <div class="row">
                                            <div class="col-md-6 col-6">
                                                <h3 class="m-b-0">Add New Business Licensing</h3>                                             
                                            </div>
                                            <div class="col-md-6 col-6">
                                                <div class="text-right">                            
                                                     <a href="admin-licensing.php"><button type="button" class="btn btn-info waves-effect-light btn-info btn-sm"><i class="ti-check"></i> Save</button></a>
                                                     <a href="admin-licensing.php"><button type="button" class="btn btn-info waves-effect-light btn-danger btn-sm"><i class="ti-close"></i> Cancel</button></a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <hr>
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div>
                                                    <label class="control-label">Licence Name</label>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Activity / Licence Type</label>
                                        ...
                                        <!--/row-->
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div>
                                                    <label class="control-label">Category Licence</label>
                                        ...
                                        <div class="row">
                                         ...
                                         <h6 class="m-t-20 text-success"> Section 3 - Action </h6>
                                        <hr>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 m-t-20">
                                                <label class="custom-control custom-radio" style="display: inline-block; padding-right: 30px;">
                                                    <input id="radio2" name="radio" type="radio" class="custom-control-input">
                                                    <span class="custom-control-label">Download Form</span>
                                                </label>
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div>
                                                    <label class="control-label">Fi/ Licene Expire Date</label>
                                                     <input type="text" id="name" class="form-control">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Act and Regulations</label>
                                                    <input type="text" id="path" class="form-control" required data-validation-required-message="This field is required">
                                                </div>
                                            </div>
                                            <!--/span-->
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div>
                                                    <label class="control-label">Qulified Business Entity</label>
                                                     <input type="text" id="name" class="form-control">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Online Services URL</label>
                                                    <input type="text" id="path" class="form-control">
                                                </div>
                                            </div>
                                            <!--/span-->
