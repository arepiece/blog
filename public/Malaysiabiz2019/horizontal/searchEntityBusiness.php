        ...
        <div id="main-wrapper">
            ...
            <!-- ============================================================== -->
                                ...
                                <div class="container-fluid" style="padding: 0 50px;">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <h6 class="card-subtitle">Step 1: Define your business entity</h6>
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <h5 class="m-t-30 m-b-10">What is your business entity?</h5>
                    ...
                    function goToEntity(){
                        ...
                        location.href='searchEntityBusinessResult.php?entity='+value;
                    }
                    </script>
