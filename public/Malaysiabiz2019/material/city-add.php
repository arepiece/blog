                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Code <span class="text-danger">*</span></label>
                                                     <input type="text" id="citycode" class="form-control" maxlength="6" placeholder="Enter city code">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/row-->
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="name" id="cityname" class="form-control" placeholder="Enter city name">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                    <div class="form-group">
