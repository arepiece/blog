                                         ...
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">State Code <span class="text-danger">*</span></label>
                                                     <input type="text" id="statecode" class="form-control" maxlength="2" value="01">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="name" id="statename" class="form-control" value="Johor">
                                                </div>
                                            </div>
