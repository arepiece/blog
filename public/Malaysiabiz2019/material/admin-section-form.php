...
<head>
    ...
    <title name="form-title">Section Form</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar card-no-border">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6 col-6">
                                                <h3 name="form-title" class="m-b-0" name="form-title">Add Section</h3>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="text-right">
                                                    <a href="admin-section.php"><button type="button" name="btnSave"
                                                    ...
                                                    <a href="admin-section.php"><button type="button" class="btn waves-effect-light btn-danger btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="Click to cancel and back to the main page"><i
                                        ...
                                        <div class="row m-b-20">
                                            <div class="col-md-6">
                                                <div>
                                                    ...
                                                    <input type="text" id="name" class="form-control" name="section_code">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
    ...
    <script>
        $(this).parentSideNavbar('admin-section.php')
    </script>
    <!-- ============================================================== -->
    <!-- Style switcher -->
    <!-- ============================================================== -->
