...
<!-- ============================================================== -->                       
		<div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <button class="btn btn-sm btn-info" data-toggle="modal" data-target="#add-login-id" data-url="#" ><i class="ti-plus"></i> Add New Login ID</button>
...
<?php } else { ?>
        ...
        <!-- Add Login ID -->
					...
					<div class="modal fade bs-example-modal-lg" id="add-login-id" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-dialog-license modal-lg">
                            <div class="modal-content">
								...
								<div class="col-md-12">
                                <label for="exampleInputuname" class="col-sm-3 control-label" style="padding-top: 17px; padding-left: 7px;">Login Into Agency: <span class="text-danger">*</span></label>
                                <div class="col-sm-6" style="padding-left:7px">
                                     ...
                                     <select class="form-control form-control-sm" id="login_id_type" name="login_id_type">
                                        ...
                                        <option value="https://www.bqsm.gov.my/index.php/en/?option=com_users&view=login">Lembaga Juruukur Bahan Malaysia (LJBM)</option>
                                        <option value=" http://ilaunch13.duckdns.org/eljt/login?logout">Lembaga Jurukur Tanah Malaysia (LJTM)</option>
                                        <option value="http://portal.lam.gov.my/online_login_firm.php">Lembaga Arkitek Malaysia (LAM)</option>
                                        <option value="http://apps.halal.gov.my/myehalal/pemohon/index.php">Jabatan Kemajuan Agama Islam (JAKIM)</option>
                                    </select> 
                                </div>
                            </div>
                                <div class="modal-body">

                                    <iframe id="business-reg-iframe" src="http://ilaunch13.duckdns.org/eljt/login?logout" style="overflow: scroll; width:100%; height:500px"></iframe>

                                </div>
                                <div class="modal-footer">
									<button type="button" class="btn btn-info btn-sm" data-dismiss="modal">Continue</button>
					...
					<!-- http://ilaunch13.duckdns.org/eljt/login?logout (Login LJTM) 
						http://apps.halal.gov.my/myehalal/pemohon/index.php (Login JAKIM)
						https://www.bqsm.gov.my/index.php/en/?option=com_users&view=login (Login LJBM)
					-->
...
<script>
	 $(function(){
      ...
      $('#login_id_type').on('change', function () {
          var url = $(this).val(); // get selected value
          if (url) { // require a URL
             // window.location = url; // redirect
			 $('#business-reg-iframe').attr("src",url);
          }
          return false;
      });
    });
