               ...
               <div class="card">
                    <div class="card-body">
                        ...
                        <h6 class="card-subtitle" style="padding-left:0">Please use these step to perform the search : </h6>
						 ...
						 <div class="row">
                            <div class="col-md-4">
                                <h6 class="m-t-10 m-b-10"><span class="label label-info">Step 1</span> Define your business registration type</h6>
								</div>
								</div>
...
<script>
    function goToEntity() {
        ...
        location.href = 'SearchBusinessregistrationsearchresult.php?&agency='+agency+'&service='+service+'&entity=' + entity;
	}	
