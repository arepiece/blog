...
<head>
    ...
    <title>Add New Business Registration</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor">Business</h3>
                        <ol class="breadcrumb">
                                    ...
                                    <div class="form-body">
                                       <div class="row">
                                            <div class="col-md-6 col-6">
                                                <h3 class="m-b-0">Add New Business Registration</h3>                                             
                                            </div>
                                            <div class="col-md-6 col-6">
                                                <div class="text-right">                            
                                                     <a href="admin-business.php"><button type="button" class="btn btn-info waves-effect-light btn-info btn-sm"><i class="ti-check"></i> Save</button></a>
                                                     <a href="admin-business.php"><button type="button" class="btn btn-info waves-effect-light btn-danger btn-sm"><i class="ti-close"></i> Cancel</button></a>
                                                </div>
                                            </div>
                                        </div>
                                         ...
                                         <div class="row">
                                                ...
                                                <div>
                                                    <label class="control-label">Agency</label>
                                                     <select class="custom-select col-12" id="inlineFormCustomSelect">
                                                        <option selected="">Lembaga Arkitek Malaysia</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Profesional Qualification</label>
                                                   <select class="custom-select col-12" id="inlineFormCustomSelect">
                                        ...
                                        <!--/row-->
                                         <div class="row">
                                            <div class="col-md-6">
                                                <div>
                                                    <label class="control-label">Field of Service</label>
                                        ...
                                        <!--/row-->
                                         <h6 class="m-t-20 text-success"> Section 3 </h6>
                                        <hr>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
