...
<head>
    ...
    <title name="form-title">State</title>
    <!-- Bootstrap Core CSS -->
...
<body class="fix-header fix-sidebar card-no-border">
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        <h3 class="text-themecolor" name="form-title">State</h3>
                        <ol class="breadcrumb">
                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6 col-6">
                                                <h3 class="m-b-0" name="form-title">Edit Stdsadsadate</h3>
                                            </div>
                                            <div class="col-md-6 col-6">
                                                <div class="text-right">
                                                    <button type="submit" class="btn btn-info waves-effect-light btn-info btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="Click to submit and back to the main page"
                                                        name="btnSave"><i class="ti-check"></i> Submit</button>
                                                    <a href="admin-state.php"><button type="button" class="btn btn-info waves-effect-light btn-danger btn-sm" data-toggle="tooltip" data-placement="left" title="" data-original-title="Click to cancel and back to the main page"><i
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text " id="statecode" class="form-control" maxlength="2"
                                                             name="code" autocomplete="on">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="name" id="statename" class="form-control" 
    ...
    <script>
        $(this).parentSideNavbar('admin-state.php')
    </script>
</body>
<meta name="viewport" content="width=device-width, initial-scale=1">
<style>
